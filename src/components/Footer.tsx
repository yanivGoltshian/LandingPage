    ...
    <footer className="bg-ink text-white/70">
      <div className="mx-auto max-w-6xl px-4 pt-14 pb-8">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          {/* categories */}
          <div>
            <h4 className="font-display text-base font-bold text-white mb-4">קטגוריות</h4>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/products/" className="hover:text-white transition">כל המוצרים</Link></li>
              <li><Link href="/branded/" className="hover:text-white transition">שקיות ממותגות</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><span className="text-white/45">נייד:</span> <a href={telLink(site.phone2)} className="hover:text-white transition">{site.phone2}</a></li>
              <li><span className="text-white/45">אימייל:</span> <a href={`mailto:${site.email}`} className="hover:text-white transition break-all">{site.email}</a></li>
              ...
              <li>
                <a href={whatsappLink("היי, אשמח לקבל הצעת מחיר")} target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center gap-2 rounded-full bg-eco px-4 py-2 text-sm font-semibold text-white hover:brightness-110 transition">
                  וואטסאפ
                </a>
              </li>
            </ul>
