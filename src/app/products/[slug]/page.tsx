    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <nav className="text-sm text-muted mb-6 flex gap-2">
          ...
          <span>/</span>
          <Link href="/products/" className="hover:text-brand">מוצרים</Link>
          <span>/</span>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href={whatsappLink(`היי, אשמח להצעת מחיר עבור ${product.name}`)} target="_blank" rel="noopener noreferrer" className="rounded-full bg-eco px-6 py-3 font-semibold text-white hover:bg-eco-dark transition">
                הצעת מחיר בוואטסאפ
              </a>
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2 items-start">
          <div className="rounded-3xl border border-border bg-white p-6 sm:p-8">
            <h2 className="text-2xl font-black">בקשת הצעת מחיר ל{product.name}</h2>
          ...
          {related.length > 0 && (
            <div>
              <h2 className="text-2xl font-black mb-6">מוצרים נוספים</h2>
